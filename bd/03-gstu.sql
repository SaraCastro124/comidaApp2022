...
GRANT SELECT(idRestaurante, email, nombre, domicilio) ON ComidApp.Restaurante TO 'cliente'@'%';
GRANT INSERT(idPlato, Nropedido, cantidad, precio) ON ComidApp.detallePedido TO 'cliente'@'%';
...
GRANT INSERT, UPDATE(idPlato, precioUnitario, disponibilidad) ON ComidApp.Plato TO 'adminResto'@'localhost';